...
using Tyuiu.SmrinovMN.Sprint6.Task1.V17.Lib;


namespace Tyuiu.SmrinovMN.Sprint6.Task1.V17
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 1 выполнил студент группы ИИПб-23-2 Смирнов М. Н.", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}